...
// 链接库
//#pragma comment (lib, "thostmduserapi_se")
//#pragma comment (lib, "thosttraderapi_se")
...
//	g_pMdUserApi = CThostFtdcMdApi::CreateFtdcMdApi();   // 创建行情实例
	...
	// 初始化交易线程
	cout << "初始化交易..." << endl;
    // need comment it  for  mac
//	g_pTradeUserApi = CThostFtdcTraderApi::CreateFtdcTraderApi("data"); // 创建交易实例
